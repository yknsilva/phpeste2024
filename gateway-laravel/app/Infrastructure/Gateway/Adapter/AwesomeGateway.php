...
class AwesomeGateway implements ChargePayment, CapturePayment, CancelPayment, RefundPayment
{
    public function charge(
        ...
        return PaymentOperationResult::buildSuccess(
            "[Laravel] Awesome Gateway: charge successful",
    ...
    {
        return PaymentOperationResult::buildSuccess(
            "[Laravel] Awesome Gateway: capture successful",
    ...
    {
        return PaymentOperationResult::buildSuccess(
            "[Laravel] Awesome Gateway: cancel successful",
    ...
    {
        return PaymentOperationResult::buildSuccess(
            "[Laravel] Awesome Gateway: refund successful",
